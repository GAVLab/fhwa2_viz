"""autogenerated by genpy from fhwa2_error/PoseError.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import fhwa2_error.msg
import std_msgs.msg

class PoseError(genpy.Message):
  _md5sum = "8d00e3277ce0a9626b61e8802c98fa07"
  _type = "fhwa2_error/PoseError"
...
================================================================================
MSG: fhwa2_error/PointError
float64 east
float64 nrth
float32 elev
"""
  __slots__ = ['header','reference_frame','target_frame','mag_horiz','error']
  _slot_types = ['std_msgs/Header','string','string','float32','fhwa2_error/PointError']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.error is None:
        self.error = fhwa2_error.msg.PointError()
    else:
      self.header = std_msgs.msg.Header()
      self.reference_frame = ''
      self.target_frame = ''
